...
public class VentanaCajeroIngresar extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaCajeroIngresar window = new VentanaCajeroIngresar(cuentaActual, usuarioActual);
	 ...
	 */
	public VentanaCajeroIngresar(Cuenta c, Usuario u) {
		...
		getxobank = new ImageIcon(VentanaCajeroIngresar.class.getResource("logo_small.png"));
		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ventanaActual.dispose();
				VentanaHome ventanaHome = new VentanaHome(cuentaActual, usuarioActual);
				ventanaHome.modelo.addRow(new Object[] {null, "Ingresar Dinero", Integer.valueOf(txtCantidad.getText()), System.currentTimeMillis()});
				ventanaHome.setVisible(true);
			}
		});
